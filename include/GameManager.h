...
private:
    ...
    static constexpr int TICKS_PER_SCORE_LOSS = 200; // ~10s if Sleep(50)
    static constexpr int SCORE_LOSS_PER_STEP = 10;
...
public:
    ...
    bool getIsColorEnabled() const { return isColorEnabled; }
};
